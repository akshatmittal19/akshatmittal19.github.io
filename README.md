...
Update biography, projects, and links in `index.html`. Colors and layout are in `styles.css`. The content is based on the public GitHub profile and public repository descriptions.

## Preview

Run `python3 -m http.server 8000` in this folder and visit http://localhost:8000. Stop with Ctrl+C.
